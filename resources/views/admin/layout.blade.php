            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-center">
                        <div class="logo shadow rounded">
                            <a href="{{ route('home') }}">
                                <img src='{{ asset("assets/images/e-gifts-color.png") }}' alt="Logo" srcset="" style="height:100px;" class="">
                            </a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('menucategory') || request()->routeIs('menucategoryCreate') ? 'active' : '' }}">
                            <a href="{{route('menucategory')}}" class='sidebar-link'>
