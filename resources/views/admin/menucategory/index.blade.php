...
@section('button')
  <a href="{{ route('menucategoryCreate') }}" class="btn btn-outline-primary">Create</a>
@endsection
@section('content')
  <div class="card">
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <a href="javascript:void(0)" onclick="alertconfirm('{{route('menucategoryDelete', ['id' => $item->id] )}}')"  class="btn btn-sm btn-danger"><i class="bi bi-trash"></i></a>
                        <a href="{{ route('menucategoryEdit', $item->slug ) }}"  class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                        @if($k > 0)
                        <a href="/admin/menucategory/move-up/{{$item->id}}"  class="btn btn-sm btn-success"><i class="bi bi-arrow-up-square-fill"></i></a>
                        @endif
                        @if($k < count($category) - 1)
                        <a href="/admin/menucategory/move-down/{{$item->id}}"  class="btn btn-sm btn-success"><i class="bi bi-arrow-down-square-fill"></i></a>
                        @endif
                    </td>
                </tr>
...
$(document).on('click', '.delete-all', function() {
    ...
    $.ajax({
        ...
        url: "/admin/menucategory/delete-all", // Replace with your server endpoint
